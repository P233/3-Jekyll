...
html调用:
```html
<iframe  src="http://box-yoyo.blog.163.com/blog/a.html"  frameborder="no" border="0"   framespacing="0" scrolling="No" noresize="noresize" onload="SetIframeHeight(this)"></iframe>
```